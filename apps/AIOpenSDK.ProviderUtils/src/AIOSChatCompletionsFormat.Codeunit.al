...
/// <summary>
/// Shared Chat Completions wire format (provider-utils). Used by OpenAI, OpenAI Compatible, and OpenCode Zen.
/// </summary>
codeunit 87435 "AIOS Chat Completions Format" implements "AIOS Chat Format"
{
    Access = Public;
