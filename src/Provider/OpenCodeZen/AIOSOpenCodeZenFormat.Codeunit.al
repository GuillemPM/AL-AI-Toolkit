...
/// <summary>
/// Chat/tools wire format for this provider (OpenAI Chat Completions schema).
/// Owned by the OpenCode Zen provider — no dependency on other providers.
/// </summary>
codeunit 87433 "AIOS OpenCode Zen Format" implements "AIOS Chat Format"
{
    Access = Public;
